...
public class BaseTest extends FrameworkBase {
	...
	public static Properties testInputData=new Properties() ;
	/**
	...
	public static Properties loadTestData(){
		...
		String filename = System.getProperty("user.dir") + "\\TestData\\"+config.getProperty("testDataFileName");
		try {
			
			final FileInputStream fileInput = new FileInputStream(filename);
			testInputData.load(fileInput);
	...
	public static Properties getTestInputData() {
		return loadTestData();
	}
